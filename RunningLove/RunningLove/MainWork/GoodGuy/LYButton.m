...
-(instancetype)initWithFrame:(CGRect)frame{
    if(self = [super initWithFrame:frame]){
        ...
        _shapeLayer.strokeColor = KLoginYellow.CGColor;
        ...
        [_button setTitleColor:KLoginYellow forState:UIControlStateNormal];
...
-(void)clickAnimation{
    ...
    clickCicrleLayer.fillColor = KLoginYellow.CGColor;
...
-(void)clickNextAnimation{
    ...
    _clickCicrleLayer.fillColor = [UIColor lightGrayColor].CGColor;
    _clickCicrleLayer.strokeColor = [UIColor lightGrayColor].CGColor;
...
-(void)startMaskAnimation{
    ...
    [self performSelector:@selector(qweqwe) withObject:self afterDelay:0];
...
-(void)loadingAnimation{
    ...
    _loadingLayer.strokeColor = KLoginYellow.CGColor;
