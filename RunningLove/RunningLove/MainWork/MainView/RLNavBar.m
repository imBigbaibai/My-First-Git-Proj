...
@implementation RLNavBar

+ (RLNavBar *)creatWithMainButton:(NSString *)mainButton optionButton:(NSArray *)buttons Title:(NSString *)title
{
    RLNavBar *nav = [[RLNavBar alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, 64)];
    nav.backgroundColor = KBaseColor;
    NSMutableArray *array=[NSMutableArray array];
    
    //创建左侧主按钮
    UIButton *main=[[UIButton alloc]initWithFrame:CGRectMake(5, 27, 45, 30)];
    [nav addSubview:main];
